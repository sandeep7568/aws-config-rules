...
class ComplianceTest(unittest.TestCase):
    ...
    def test_invalidruleparameter_returnserror(self):
        rule_invalid_parameter = {
    ...
    def test_config_compliant_table(self):
    ...
    def test_config_non_compliant_table(self):
    ...
    def test_config_compliant_table_with_params(self):
    ...
    def test_config_non_compliant_table_with_params(self):
        valid_rule_parameter = {
            "KmsKeyArns": [
                "arn:aws:kms:ap-southeast-2:437313072050:key/f4fb52b5-03a0-4397-a2db-cb5b94abb0a6",
                "arn:aws:kms:ap-southeast-2:437313072050:key/ff61230d-5aa3-4ece-9532-a97fecb51f36"
    ...
    def test_config_not_applicable_table(self):
    ...
    def test_periodic_compliant_table(self):
    ...
    def test_periodic_non_compliant_table(self):
    ...
    def test_periodic_compliant_table_with_params(self):
        valid_rule_parameter = {
            "KmsKeyArns": [
                "arn:aws:kms:ap-southeast-2:437313072050:key/f4fb52b5-03a0-4397-a2db-cb5b94abb0a6",
                "arn:aws:kms:ap-southeast-2:437313072050:key/ff61230d-5aa3-4ece-9532-a97fecb51f36"
    ...
    def test_periodic_non_compliant_table_with_params(self):
        valid_rule_parameter = {
            "KmsKeyArns": [
                "arn:aws:kms:ap-southeast-2:437313072050:key/f4fb52b5-03a0-4397-a2db-cb5b94abb0a6",
                "arn:aws:kms:ap-southeast-2:437313072050:key/ff61230d-5aa3-4ece-9532-a97fecb51f36"
